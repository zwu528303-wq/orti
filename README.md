...
- `corepack pnpm generate:questions` regenerates `src/data/questions.ts` from `orti-questions-v1.md`

## Project Notes

- The landing page supports last-result recall and quiz draft resume
- The quiz currently uses the 17 questions generated from `orti-questions-v1.md`
